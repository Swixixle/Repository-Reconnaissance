...
**Test**:
```bash
$ curl -s -H "x-api-key: dev-test-key-12345" http://localhost:5000/api/research/export
```
...
curl -X POST -H "Content-Type: application/json" -H "x-api-key: dev-test-key-12345" \
  ...
  http://localhost:5000/api/receipts/p6-kill-switch-test/observe
```
...
curl -X POST -H "Content-Type: application/json" -H "x-api-key: dev-test-key-12345" \
  ...
  http://localhost:5000/api/receipts/p6-kill-switch-test/observe/multi
```
...
curl -H "x-api-key: dev-test-key-12345" \
  http://localhost:5000/api/receipts/p6-kill-switch-test/observations
```
...
curl -X POST -H "Content-Type: application/json" -H "x-api-key: dev-test-key-12345" \
  ...
  http://localhost:5000/api/receipts/p6-llm-test-receipt/observe/multi
```
...
curl -X POST -H "Content-Type: application/json" \
  -d '{"observation_type": "paraphrase"}' \
  http://localhost:5000/api/receipts/p6-llm-test-receipt/observe
```
...
```bash
curl http://localhost:5000/api/receipts/p6-llm-test-receipt/observations
```
...
```bash
$ grep -r "OPENAI_API_KEY\|ANTHROPIC_API_KEY" client/
